...
{% capture fig_img %} ![Foo]({{ '/images/posts/damasceno_splc19_photo02.jpg' | relative_url }}) {% endcapture %}
...
{% capture fig_img %} ![Foo]({{ '/images/posts/damasceno_splc19_photo01.jpg' | relative_url }}) {% endcapture %}
{{ fig_img | markdownify | remove: "" | remove: "" }} 
Photo by 
